...
const SchoolProfileSection = () => {
  ...
  return (
    <motion.section
      ...
      variants={fadeInUp}
    >
      <div className="absolute -top-16 -right-16 w-32 h-32 bg-emerald-100 rounded-full opacity-20 blur-3xl" />
      <div className="absolute -bottom-16 -left-16 w-64 h-64 bg-emerald-100 rounded-full opacity-10 blur-3xl" />

      <Card>
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div variants={fadeInLeft} className="relative space-y-6">
            <div>
              <BadgeLabel text="Tentang Kami" variant="sky" size="sm" />
              <TitleSection
                text="Profil Sekolah"
                highlight="Sekolah"
                size="2xl"
            ...
            <div className="space-y-4 text-gray-600">
              <DescriptionSection>
                SMA Taruna Nusantara adalah sekolah menengah atas yang
                berkomitmen untuk membentuk generasi muda yang berintegritas,
                berkarakter, dan siap menghadapi tantangan masa depan.
              </DescriptionSection>
              <DescriptionSection>
                Dengan kurikulum komprehensif dan fasilitas modern, kami
                memberikan pendidikan terbaik yang menggabungkan akademik dan
